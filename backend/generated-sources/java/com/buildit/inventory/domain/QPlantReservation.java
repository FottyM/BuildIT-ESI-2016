...
import com.buildit.inventory.domain.model.PlantReservation;
...
public class QPlantReservation extends EntityPathBase<PlantReservation> {
    ...
    private static final long serialVersionUID = -61271876L;
    ...
    public final com.buildit.common.domain.model.QBusinessPeriod schedule;
    ...
    public QPlantReservation(Class<? extends PlantReservation> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.schedule = inits.isInitialized("schedule") ? new com.buildit.common.domain.model.QBusinessPeriod(forProperty("schedule")) : null;
    }
